...
```bash
npx shadcn@latest add checkbox dialog tabs badge textarea sonner slider scroll-area accordion radio-group
```
...
- `radio-group` : choix du mode d'intro (découpée / synthétique) — spec 07
